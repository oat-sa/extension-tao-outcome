 ...
 */
class exampleDBResultServerTestCase extends UnitTestCase {
	 /**
	  *
    ...
    public function testResultServerWorstCase() {
        $aResultServerUsingTaoResultsStorage  = TAO_DEFAULT_RESULT_SERVER;
        //the uri of a resultserver in the KB and probably associated with the delivery
        $resultServer = new taoResultServer_models_classes_ResultServer($aResultServerUsingTaoResultsStorage);
        ...
        //you may also provide your own identifier like a (example : lis_result_sourcedid:GUID)
