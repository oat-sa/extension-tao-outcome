...
class taoResultServer_models_classes_Context
{
     ...
     * Subsequent systems that process the result might assign their own identifier to the session which should be
     * added to the context if the result is modified and exported for transport again.
     *
